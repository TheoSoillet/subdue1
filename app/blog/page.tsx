...
export const metadata: Metadata = {
  title: "Resources | Subdue Consulting",
  description:
    "Discover our past projects and how we have helped our clients succeed.",
      ...
      <Container className="flex flex-col items-center justify-between pb-20">
        <div className="relative z-20 py-10 md:pt-40">
          <FeatureIconContainer className="flex justify-center items-center overflow-hidden">
            <IconClipboardText className="h-6 w-6 text-[#F1D089]" />
          </FeatureIconContainer>
          <Heading as="h1" className="mt-4">
            Case Studies
          </Heading>
          <Subheading className="text-center">
            Learn about our past projects and how we have helped our clients
            succeed.
          </Subheading>
        </div>
