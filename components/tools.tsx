    ...
    >
      <div className="px-6">
        <FeatureIconContainer className="flex justify-center items-center overflow-hidden">
          <IconTool className="h-6 w-6 text-[#F1D089]" />
        </FeatureIconContainer>
        <Heading className="mt-4">Wide capabilities for a few industries</Heading>
        <Subheading>
          Limiting the number of industries is a way for us to develop our
          capabilities and make our services more relevant to the industries
          that we are in.
        </Subheading>
      </div>
