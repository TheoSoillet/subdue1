...
const CareersPage = () => {
    ...
    return (
        <div className="flex flex-col px-5 bg-[#131213] text-base leading-[57px] pl-40 pr-40 pt-60">
            ...
            <div className="flex flex-col items-center px-16 mt-20 w-full text-xl text-white max-md:px-5 max-md:mt-10 max-md:max-w-full">
                ...
                />
                <div className="mt-16 text-4xl font-medium leading-10 text-center max-md:mt-10 max-md:max-w-full">
                    We develop marketing strategies with a deep respect for diverse experiences and perspectives.
                </div>
                <div className="mt-20 text-xl font-semibold text-left max-md:mt-10" style={{ textAlign: 'left' }}>
                ...
                <div className="mt-12 text-xl font-semibold text-left max-md:mt-10">
                    Intense & Scrappy
                </div>
                ...
                <div className="mt-11 text-xl font-semibold text-left max-md:mt-10">
                    Make Something People Love
                </div>
                <div className="mt-7 text-left max-md:max-w-full">
                    Our strategies and solutions should have a transformatively positive effect on our clients' businesses.
                </div>
                <div ref={openRolesRef} className="mt-24 text-5xl font-medium text-center leading-[57.77px] max-md:mt-10 max-md:text-4xl">
                    Open roles
                </div>
            </div>
