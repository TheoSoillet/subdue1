  ...
  return (
    <div className=" [perspective:400px] [transform-style:preserve-3d]">
      ...
      >
        ...
        <div className="absolute bottom-0 inset-x-0 bg-gradient-to-r from-transparent via-[#F1D089] to-transparent h-px w-[60%] mx-auto"></div>
        <div className="absolute bottom-0 inset-x-0 bg-gradient-to-r from-transparent via-[#F1D089] blur-sm to-transparent h-[8px] w-[60%] mx-auto"></div>
      </div>
    </div>
  );
};
