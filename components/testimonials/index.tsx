    ...
    <div className="relative">
      ...
      <div className="pb-20">
        <FeatureIconContainer className="flex justify-center items-center overflow-hidden">
          <TbLocationBolt className="h-6 w-6 text-[#F1D089]" />
        </FeatureIconContainer>
        <Heading className="pt-4">Approved by other businesses</Heading>
        <Subheading>
          Subdue Consulting helped 10+ companies grow their business.
        </Subheading>
      </div>
